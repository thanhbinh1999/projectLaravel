...
.form-producer{
	...
	<div class="right_col col-md-10 col-sm-9"  role= 'main'>
				<div class="row" >
					<div class="col-md-9 form-category form-update">
						<div class="table-responsive">
							...
							<tr>
								<td><label>Quản trị danh mục</label></td>
								<td>
									<span class="error-name"></span>
									<div class="form-group">
										<input class="form-control categoryName "type="text" >
									</div>
								</td>
							</tr>
							<tr>
							...
							<tr>
								<td><button class="btn btn-primary update-category">Cập nhật</button><button class="btn btn-danger cancel">Hủy</button></td>
							</tr>
						</table>
						</div>
					</div>
							...
							<h3>Trang danh mục</h3>
								<div>
									<div class="insert" style="float: left;margin-bottom: 10px">
										<button class="btn btn-danger add-new-category">Tạo mới</button>
									</div>
							<tr class="title" >
								<td>STT</td>
								...
								<tr class="producer">
									...
									<td>
										 <button class="btn btn-{{($lists['statusID'] == 'active')?'primary':'danger'}}">
										 	{{($lists['statusID'] == 'active')?'Đang hoạt động':'Ngưng hoạt động'}}
										 </button>
									</td>
									<td>
										<button  class="btn btn-primary edit-category" edit-category-id = "{{$lists['ID']}}">
											<i class="fa fa-pencil-square-o " aria-hidden="true"></i>
										</button >
										<button  class="btn btn-danger delete-category" delete-category-id="{{$lists['ID'] }}">
